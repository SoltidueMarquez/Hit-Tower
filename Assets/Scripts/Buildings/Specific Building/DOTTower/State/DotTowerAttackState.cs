...
{
    public class DotTowerAttackState : IState
    {
        ...
        private void DoSingleAtk(EnemyMono mono)
        {
            ...
            // 加灼烧buff
            mono.enemyLogic.BuffHandler.AddBuff(new BuffInfo(GameManager.Instance.buffManager.GetBuffData(2),m_Building.gameObject,mono.gameObject));
        }
